        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Attendance Management</h1>
              <p className="text-xl mb-8">
                Track student and staff attendance with ease using our comprehensive attendance system
              </p>
            ...
            <div className="md:w-1/2">
              <img src="/admin-dashboard.png" alt="Attendance Dashboard" className="rounded-lg shadow-xl" />
            </div>
          </div>
        </div>
      </section>
